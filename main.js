...
const mapResult = myArray.map((number, index) => {
  return number * index;
});

console.log("myArray.arrayは[1, 2, 3]であるべき: " + myArray.array);
console.log("mapの戻り値は[0, 2, 6]であるべき: " + mapResult);
...
const filterResult = myArray.filter(number => {
  return number % 2 === 1;
});

console.log("myArray.arrayは[1, 2, 3]であるべき: " + myArray.array);
console.log("filterの戻り値は[1, 3]であるべき: " + filterResult);
